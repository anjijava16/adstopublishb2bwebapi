...
public class CommonConstants {
	...
	public static final String MAIL_SMTP_PORT_NUMBER = "587";
	...
	public static final String FROMEMAIL = "degitalmedia1@gmail.com";
	
	public static final String PASSWORD = "saptalabs";
